...
void PORT2_Init(void)
{
    ...
    SetP2nQuasiMode(PIN_7 | PIN_6 | PIN_3 | PIN_2 | PIN_1 | PIN_0); //设置P2.7,P2.6,P2.3,P2.2,P2.1,P2.0为准双向口模式
    SetP2nOpenDrainMode(PIN_5 | PIN_4); //设置P2.5,P2.4为开漏模式
    ...
    SetP2nSlewRateNormal(PIN_7 | PIN_6 | PIN_3 | PIN_2 | PIN_1 | PIN_0); //设置P2.7,P2.6,P2.3,P2.2,P2.1,P2.0一般翻转速度
    SetP2nSlewRateFast(PIN_5 | PIN_4);  //设置P2.5,P2.4快速翻转速度
