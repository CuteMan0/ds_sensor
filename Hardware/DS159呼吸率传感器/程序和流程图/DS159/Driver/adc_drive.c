...
{  
    ...
    switch (channel)
    {
        case 0: P1_MODE_IN_HIZ(1 << 0); break;
        case 1: P1_MODE_IN_HIZ(1 << 1); break;
        case 2: P1_MODE_IN_HIZ(1 << 2); break;
        case 3: P1_MODE_IN_HIZ(1 << 3); break;
        case 4: P1_MODE_IN_HIZ(1 << 4); break;
        case 5: P1_MODE_IN_HIZ(1 << 5); break;
        case 6: P1_MODE_IN_HIZ(1 << 6); break;
        case 7: P1_MODE_IN_HIZ(1 << 7); break;
        default:
            return;
    }
